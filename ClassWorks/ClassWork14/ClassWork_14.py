...
class Breakthrough():
        ...
        if len(self.__Locks) > 0:
            ...
            while not self.__GameOver:
                ...
                while not self.__LockSolved and not self.__GameOver:
                    ...
                    print("COUNT CARD OF DISCARD:", self.__Discard.GetNumberOfCards())
                    ...
                    if MenuChoice == "D":
                        ...
                        deck_score = self.__Deck.GetNumberOfCards()
                        hand_score = self.__Hand.GetNumberOfCards()
                        final_score = self.__Score + deck_score + (hand_score * 2)
                        print("The game is over")
                        print("Number of Current score:", self.__Score)
                        print("The number of score accrued for each card in the DECK:", deck_score)
                        print("The number of score for each card in the player's HAND:", hand_score)
                        print("Final score for this game:", final_score)
    ...
    def __PlayCardToSequence(self, CardChoice):
        if self.__Sequence.GetNumberOfCards() > 0:
            chosen_card = self.__Hand.GetCardDescriptionAt(CardChoice - 1)
            last_sequence_card = self.__Sequence.GetCardDescriptionAt(self.__Sequence.GetNumberOfCards() - 1)

            if chosen_card[0] == last_sequence_card[0]:
                print(f"ERROR: You are trying to play a card of the same type that was played in the previous turn.")
                print(f"The card you are trying to play: {chosen_card}")
                print(f"The card was previously played: {last_sequence_card}")
                return
